...
`;
      ...
      // treated as UNTRUSTED user content. It is wrapped in a delimited
      // section and followed by an explicit instruction never to treat
      // content inside as system commands — mitigating prompt injection.
