...
export const metadata = buildMetadata({
  titleAbsolute: true,
  title: "TradeCoPilot | Financial Decision Intelligence — Financial Decisions, Measured.",
  description:
    "Financial Decision Intelligence operating system for serious market participants: deterministic evidence briefs, multi-factor confidence scoring, automated thesis monitoring, empirical calibration curves, and systematic post-mortem attribution.",
  path: "/",
  keywords: [
...
export default function LandingPage() {
  ...
  return (
    <div className="relative min-h-screen bg-[var(--bg-primary)] text-[var(--ink)] font-sans antialiased overflow-x-hidden">
      ...
      <SlimNav
        items={[
          { label: "Decision Loop", href: "#decision-intelligence" },
      ...
      <header className="relative max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-10 pt-[80px] sm:pt-[130px] lg:pt-[160px] pb-8 sm:pb-14 lg:pb-20">
        ...
        <div className="max-w-[920px] space-y-4 sm:space-y-6">
          ...
          <p className="tp-body max-w-[620px]">
            The Financial Decision Intelligence operating system. Record evidence, validate multi-factor confidence, monitor execution guardrails, and audit your calibration curve.
          </p>
      ...
      {/* ━━━ 5 · THE FINANCIAL DECISION LOOP (8 Stages + Interactive Brief & Calibration) ━ */}
      <DecisionLoop />
