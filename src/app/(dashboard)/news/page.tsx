...
// "ALL" + the registry's curated popular instruments. Adding a filterable
// asset is a `popular: true` edit on its registry entry, not a UI edit here.
const FILTER_ASSETS = ["ALL", ...getPopularSymbolStrings()];
