...
const MORE_ITEMS = [
  { label: "Decisions", icon: Target, href: "/theses" },
  { label: "Calibration", icon: CheckCircle2, href: "/calibration" },
  { label: "Your Patterns", icon: Sparkles, href: "/patterns" },
  { label: "Watchlist", icon: Eye, href: "/watchlist" },
  { label: "Intelligence", icon: Activity, href: "/market-pulse" },
  { label: "Research", icon: Bot, href: "/ai-assistant" },
