    ...
    <div className="flex flex-col gap-6">
      ...
      {isLoading ? (
        ...
        <EmptyState
          ...
          badge="DECISION AUDITING"
          title="No logged executions found"
          description="Your trade journal links directly with your committed theses. Logging entry, stop, take profit, and post-trade emotional tags feeds into your Decision Score and calibration curve."
          reason={filterStatus !== "ALL" || filterSymbol ? "No records match the current active filter." : "Your journal is empty. Log your first execution to start tracking process adherence."}
